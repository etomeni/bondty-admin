      ...
      <div className="component-border">
        ...
        <div className="bg-gray-100 border-b border-gray-200 px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-medium text-gray-900">Bondyt order</h1>
          </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-12 mt-6">
            <div>
              ...
              <button className="px-6 py-3 bg-purple-600 text-white rounded-md text-sm mb-4">
                {order?.sender?.first_name || "Unknown Sender"}
              </button>
              <p className="text-sm text-gray-600 border border-gray-200 rounded-lg p-4">
                {order?.message || "No message"}
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium text-gray-900 mb-4">Receiver</h3>
              <button className="px-6 py-3 bg-purple-200 text-purple-900 rounded-md text-sm mb-4">
