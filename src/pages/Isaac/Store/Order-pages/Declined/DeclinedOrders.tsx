...
import { fetchDeclinedOrders, type FilterCategory } from "./declinedApi"
import type { ProductOrder } from "./types"
import { FilterModal } from "./declinedfilter-modal"
...
export default function DeclinedOrders() {
  ...
  useEffect(() => {
    async function loadOrders() {
      try {
        setIsLoading(true)
        const response = await fetchDeclinedOrders(selectedFilter)
      ...
      <div className="bg-white overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-xl font-bold text-gray-700">📭 There are no Declined orders to show</p>
          </div>
        ) : (
