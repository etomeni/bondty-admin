...
import { fetchCompletedOrders, type FilterCategory } from "./completedApi"
import type { ProductOrder } from "./types"
import { FilterModal } from "./completedfilter-modal"
...
export default function CompletedOrders() {
  ...
  useEffect(() => {
    async function loadOrders() {
      try {
        setIsLoading(true)
        const response = await fetchCompletedOrders(selectedFilter)
      ...
      <div className="bg-white overflow-hidden">
        {isLoading ? (
          ...
          <div className="p-8 text-center">
            <p className="text-xl font-bold text-gray-700">📭 There are no Completed orders to show</p>
          </div>
        ) : (
